...
\begin{question}
  % Wenn Folgendes (mit 'beliebiger', 'immer') gemeint ist,
  % kommt mir die explizitere Formulierung einfacher vor.
...
\begin{examples}
  ...
  \begin{itemize}
    ...
    \item Nicht alle Schnitte sind rational. Zum Beispiel ist
      ...
      % So definiert ist D_sqrt2 aber kein Schnitt (?), denn z.B., -1 in D_sqrt2,
      % und 1 > -1, aber 1 nin D_sqrt2. Meinst du "x^2 > 2 und x > 0"?
  \end{itemize}
\end{examples}
