...
\begin{examples}
  ...
  \begin{enumerate}[(1)]
    ...
    \item Betrachte die Funktion  $\log \colon \mathbb{R}_{>0} \to \mathbb{R}$.
      ...
      \]
      Diese Reihe ist konvergent für alle $x \in (0, 2]$. % da konv für x = 2
...
\begin{proof}[Beweis von Theorem~\ref{thm:hadamard}]
  ...
  \]
  Also existiert $N \in \mathbb{N}$ so, dass für alle $k \geq N$ gilt, dass % oder ab hier überall "für alle n \geq N".
  \(
